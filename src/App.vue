   ...
   <div class="weather-info" v-if="typeof weather.main != 'undefined'">
    ...
    <div class="weather-box">
     ...
     <div class="more-info">
       ...
       <div class="wind-speed">wind speed: <span class="value">{{ weather.wind.speed }}</span>&nbsp;mph</div>

       <div class="humidity">humidity: <br> <span class="value">{{ weather.main.humidity }}</span>%</div>

       <div class="pressure">pressure: <span class="value">{{ weather.main.pressure }}</span>&nbsp;hPa</div>
